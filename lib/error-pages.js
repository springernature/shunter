...
module.exports = function (config) {
	...
	var getTemplateContext = function (err, req, fn) {
		...
		var statusAsString = typeof err.status === 'string' ? err.status : err.status.toString();
		var userData = config.errorPages;
		var layout = Object.prototype.hasOwnProperty.call(userData.errorLayouts, statusAsString) ? userData.errorLayouts[statusAsString] : userData.errorLayouts.default;
		...
		if (userData.staticData) {
			for (var key in userData.staticData) {
				...
				var userObj = userData.staticData;
				if (Object.prototype.hasOwnProperty.call(userObj, key) && !(key in templateContext)) {
